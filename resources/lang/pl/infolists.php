...
return [
    'components' => [
        'created_by_at'             => 'Obiekt <strong>:subject</strong> został <strong>:event</strong> przez <strong>:causer</strong>. <br><small> Zaktualizowano: <strong>:update_at</strong></small>',
